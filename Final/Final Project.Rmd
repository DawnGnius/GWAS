...
res.sofar <- sofar(Y, X, nrank=3, ic.type="GIC", control=list(lamA=0.0155, lamB=0.02, lamD=0.1))

heatmap(Y, Colv = NA)
heatmap(X%*%res.sofar$U%*%diag(res.sofar$D)%*%t(res.sofar$V), Colv = NA)
```